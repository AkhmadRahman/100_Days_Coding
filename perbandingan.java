public class operatorperbandingan {
    public static void main(String[] args) {
        ...
        boolean lebihbesar = umur_ari > umur_yanto; //lebih besar yoi
        boolean lebihkecil = umur_ari < umur_yanto; //lebih kecil dari
        boolean samadengan = umur_ari == umur_yanto; //sama dengan
